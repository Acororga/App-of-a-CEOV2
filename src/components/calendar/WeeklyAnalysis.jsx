...
export default function WeeklyAnalysis({ analysis }) {
  ...
  return (
    <div className="relative mb-6">
      <div className="absolute inset-0 bg-gradient-to-r from-purple-500/15 to-blue-500/15 rounded-2xl blur-xl" />
      <div className="relative p-6 rounded-2xl bg-zinc-900/70 border border-purple-700/40 backdrop-blur-sm shadow-[0_16px_64px_rgba(0,0,0,0.6)]">
        <div className="flex items-center gap-3 mb-5">
          <TrendingUp className="w-5 h-5 text-purple-400" />
          <h3 className="text-base font-black text-purple-200 tracking-tight">Week Overview</h3>
        </div>
